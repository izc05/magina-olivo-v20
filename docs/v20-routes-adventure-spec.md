...
- `database/migrations/0084_routes_adventure.sql`: juego, checkpoints, partidas y desbloqueos.
- `database/migrations/0085_route_activity_recording.sql`: grabaciones GPS privadas y voluntarias.
