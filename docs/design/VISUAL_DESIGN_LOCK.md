...
La galería completa está en `docs/design/reference/VISUAL_REFERENCE_GALLERY.html`. Contiene embebidas las 17 referencias aprobadas: identidad de marca, logo, pantallas principales y onboarding de seis pasos.
