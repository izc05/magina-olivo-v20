...
-- 0086 returns the olives; this function releases physical stock atomically.
...
COMMENT ON FUNCTION expire_stale_mill_reward_reservations(INTEGER) IS 'Atomically expires stale reward reservations, refunds olives through the 0086 trigger and releases physical stock.';
