...
- Image quality: existing generated Sierra Mágina photography supplies the correct subject, crop, depth, and rural-premium direction. No placeholder, emoji, CSS illustration, or fake image substitutes remain in the compared surfaces.
...
- P3: replace the current temporary brand sprig with the official Mágina Olivo logo when the approved source asset is supplied.
