...
export type DocumentKind = 'delivery_ticket' | 'yield_result' | 'settlement_statement' | 'collection_receipt' | 'invoice' | 'sales_invoice' | 'purchase_receipt' | 'quote' | 'treatment' | 'fertilization' | 'irrigation' | 'pruning' | 'observation' | 'work_report' | 'land_reference' | 'photo' | 'other';
