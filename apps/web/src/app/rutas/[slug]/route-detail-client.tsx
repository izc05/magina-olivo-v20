...
export function RouteDetailClient({ slug }: { slug: string }) {
  ...
  if (error || !detail) return <main className={styles.detailShell}><section className={styles.state}><h1>Ruta no disponible</h1><p>Puede estar en revisión o no disponer de track validado.</p><Link href="/rutas">Volver a rutas</Link></section></main>;
